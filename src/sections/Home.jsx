    ...
    >
      ...
      <div className="text-center font-mono z-10 px-4">
        ...
        <div className="flex justify-center items-center space-x-4">
          <a
            href="#contact"
            className=" bg-gradient-to-r flex flex-row from-teal-500 to-indigo-600 py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(59, 130, 246,0.4)] "
          >
            Contact me
          </a>
          <a
          ...
          >
            <p>Resume </p>
            <span>
              <FaDownload className=" h-5  ml-3 text-2xl text-white" />
            </span>
          </a>
        </div>
      </div>
